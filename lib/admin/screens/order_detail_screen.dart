...
class OrderDetailScreen extends StatefulWidget {
  ...
  const OrderDetailScreen({Key? key, required this.pesananId}) : super(key: key);
...
class _OrderDetailScreenState extends State<OrderDetailScreen> {
  ...
  Future<void> _updateStatus(String newStatus) async {
    ...
    try {
      final response = await ApiService.updatePesananStatus(widget.pesananId, newStatus);
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const Divider(),
                              _buildInfoRow('Nama', _data!['pesanan']['nama_customer'] ?? 'N/A'),
                              _buildInfoRow('Email', _data!['pesanan']['email'] ?? 'N/A'),
                              _buildInfoRow('No. Telepon', _data!['pesanan']['no_telepon'] ?? 'N/A'),
                            ],
                          ),
                        ),
                      ),
